...
const $video = document.querySelector("#video"),
        ...
        $boton = document.querySelector("#boton-TomarFoto"),
    ...
    const mostrarStream = idDeDispositivo => {
        _getUserMedia({
            ...
            $boton.addEventListener("click", function () {
                ...
                fetch(path+"estudiante/guardar-foto", {
                    method: "POST",
            ...
            $estado.innerHTML = "No se puede acceder a la cÃ¡mara, o no diste permiso."+error;
        });
    }
})();