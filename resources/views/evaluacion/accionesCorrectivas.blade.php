<form method="POST" action="{{url('/')}}/evaluacion/ingresar-acciones-correctivas">
...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
        <legend>Lista de Acciones Correctivas</legend>
        <table class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                foreach ($lista as $list) {
                    ...
                    <tr>
                        <td>
                            <a href="{{url('/')}}/evaluacion/acciones-correctivas/editar/{{$idCriterio}}?sub={{$idSubcriterio}}&indicador={{$Indicador->id}}&tab=acciones-correctivas&idAccion={{$list->id}}" class="btn btn-primary btn-sm">Editar</a>
                        </td>
